...
export const handler = init({
	...
	_: {
		entry: {"file":"start-14c30fff.js","js":["start-14c30fff.js","chunks/index-addc8697.js","chunks/index-5813968e.js"],"css":[]},
		nodes: [
		...
		routes: [
			...
			},
			{
				...
				names: [],
				types: [],
				load: () => import('../server/entries/endpoints/_layout.js')
			}
		],
		matchers: async () => {
